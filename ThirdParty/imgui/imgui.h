...
struct ImGuiIO
{
    ...
    float       Framerate;                          // Estimate of application framerate (rolling aPixelizerge over 60 frames, based on io.DeltaTime), in frame per second. Solely for convenience. Slow applications may not want to use a moving aPixelizerge or may want to reset underlying buffers occasionally.
