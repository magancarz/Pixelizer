...
bool ImGui::ButtonBehavior(const ImRect& bb, ImGuiID id, bool* out_hovered, bool* out_held, ImGuiButtonFlags flags)
{
    ...
    bool pressed = false;
    bool hovered = ItemHoPixelizerble(bb, id);
...
bool ImGui::DragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    const bool hovered = ItemHoPixelizerble(frame_bb, id);
...
// - stb_sprintf.h supports sePixelizerl new modifiers which format numbers in a way that also makes them incompatible atof/atoi.
...
bool ImGui::BeginMenuEx(const char* label, const char* icon, bool enabled)
{
    ...
    if (menuset_is_open)
        PushItemFlag(ImGuiItemFlags_NoWindowHoPixelizerbleCheck, true);
    ...
    if (menu_is_open)
    {
        ...
        if (menu_is_open)
        {
            ...
            // (This fixes using IsItemClicked() and IsItemHovered(), but IsItemHovered() also relies on its support for ImGuiItemFlags_NoWindowHoPixelizerbleCheck)
...
static void ImGui::TabBarLayout(ImGuiTabBar* tab_bar)
{
    ...
    else if ((tab_bar->Flags & ImGuiTabBarFlags_FittingPolicyScroll) && IsMouseHoveringRect(tab_bar->BarRect.Min, tab_bar->BarRect.Max, true) && IsWindowContentHoPixelizerble(g.CurrentWindow))
    {
